    ...
    public sealed class Changuito
    {
        ...
        public static string Mostrar(Changuito c, ETipo tipo) 
        {
            ...
            foreach (Producto v in c._productos)
            {
                ...
                {
                    case ETipo.Snacks:
                        if (v is Snacks) sb.AppendLine(((Snacks)v).Mostrar());
                        break;
                    case ETipo.Dulce:
                        if (v is Dulce) sb.AppendLine(((Dulce)v).Mostrar());
                        break;
                    case ETipo.Leche:
                        if (v is Leche) sb.AppendLine(((Leche)v).Mostrar());
                        break;
                    default:
        ...
        public static Changuito operator -(Changuito c, Producto p)
        {
            ...
            if (borrarProducto) c._productos.RemoveAt(i);
